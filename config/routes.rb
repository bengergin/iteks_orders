ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :reports, :collection => { :unplaced_orders_turkey => :get,
                                           ...
                                           :customer_profit_2013 => :get,
                                           :customer_profit_2014 => :get,
                                           :profit_percents_2013 => :get,
                                           :profit_percents_2014 => :get,
                                           :country_financials_2013 => :get,
                                           :country_financials_2014 => :get,                                      
                                           :customer_financials_2013 => :get,
                                           :customer_financials_2014 => :get,
                                           :factory_financials_2013 => :get,                                           
                                           :factory_financials_2014 => :get,
                                           :no_buy_sell => :get,
                                           :customer_orders => :get }  
